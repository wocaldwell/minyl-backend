...
# python manage.py loaddata types.json releases.json userReleases.json artists.json tracks.json trackReleases.json #loads the data from each .json file in sequential order.